...
Launching today, we now support the use of your own FQDN on development sites. This now means you can have `staging.customersite.com` as your URL, instead of the AmazeeIO server URLs. And as a bonus, if you use this you can utilized Let's Encrypt for these development sites. Want to put this in place for your site? Just reach out in Slack and we'll make it happen!
