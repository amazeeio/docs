...
Help improve our documentation! If you find anything wrong or which could be improved in our chart, please <a href="https://github.com/amazeeio/docs/blob/master/comparison.md" target="_blank">submit a pull request</a> to our GitHub repository. 
