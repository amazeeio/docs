...
| [`php70-solr3`](https://github.com/amazeeio/docker/blob/master/example-php70-solr3.yml)         | 7.0 | nginx, varnish, mariadb, solr | The same as php70-basic but additionally Apache Solr 3 installed. Check the yaml file on how to define your solr configs          |
...
| [`php56-solr3`](https://github.com/amazeeio/docker/blob/master/example-php56-solr3.yml)         | 5.6 | nginx, varnish, mariadb, solr | The same as php56-basic but additionally Apache Solr 3 installed. Check the yaml file on how to define your solr configs          |
