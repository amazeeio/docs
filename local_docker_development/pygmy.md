...
{% hint style='working' %}
You do need to be running at least Docker for Mac version 17 to run `pygmy`. If for some reason you cannot do this, a Docker Machine based tool, [`cachalot`](./os_x_cachalot.md) is available for you.
{% endhint %}
